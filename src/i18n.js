...
const resources = {
    de: {
        translation: {
            ...
            "bei der lambda9 GmbH abgeschlossen und arbeite seitdem bei Bartels-Langness (BELA) in Kiel als Softwareentwicklerin. Mein Ziel ist es, barrierefreie, kundenorientierte und innovative Anwendungen zu entwickeln, wobei": "bei der lambda9 GmbH abgeschlossen und arbeite seitdem bei Bartels-Langness (BELA) in Kiel als Softwareentwicklerin. Mein Ziel ist es, barrierefreie, kundenorientierte und innovative Anwendungen zu entwickeln, wobei",
    ...
    en: {
        translation: {
            ...
            "bei der lambda9 GmbH abgeschlossen und arbeite seitdem bei Bartels-Langness (BELA) in Kiel als Softwareentwicklerin. Mein Ziel ist es, barrierefreie, kundenorientierte und innovative Anwendungen zu entwickeln, wobei": "with an apprenticeship at lambda9 GmbH and since then I have been working as a software developer at Bartels-Langness (BELA) in Kiel. My goal is to develop accessible, customer-orientated and innovative applications, whereby ",
            ...
            "Wenn ich nicht zu Hause bin, bin ich wahrscheinlich im örtlichen Geek-Shop und kaufe Karten, Comics oder andere Dinge, für die ich nicht so viel Geld ausgeben sollte.": "When I'm not at home, I'm probably at the local geek shop buying cards, comics or other things I shouldn't be spending so much money on.",
